...
class LeaveApplication(Document):
    ...
    def validate(self):
        ...
        if self.workflow_state == "Waiting Approval" and self.leave_type in ('Maternity Leave', 'Paternity Leave', 'Bereavement Leave'):
    ...
    def on_submit(self):
        ...
        if self.leave_type not in ("Extraordinary Leave", "Study Leave", "Medical Leave", "Maternity Leave"):
...
def get_number_of_leave_days(
    ...
    if leave_type not in ("Earned Leave", "Casual Leave","Preparatory leave"):
        return final 
