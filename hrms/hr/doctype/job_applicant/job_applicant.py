...
from erpnext.custom_utils import queue_message
...
class JobApplicant(Document):
    ...
    def on_update_after_submit(self):
        if self.status == "Rejected":
            queue_message(self, self.desuup, "Your application for {} has been rejected".format(self.vacancy))
        elif self.status == "Accepted":
            queue_message(self, self.desuup, "Your application for {} has been accepted".format(self.vacancy))
        else:
            pass
