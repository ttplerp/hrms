...
# def update_training_program_participants(doc, method):
#     """
#     Update the number of participants trained in the linked Training Program.
#     Counts employees in all submitted Training Events linked to this Training Program marked as 'Present'.
#     Canceled events are ignored.
#     """
#     if not doc.training_program:
#         return

#     # Get all submitted Training Events linked to this Training Program
...
#     for event in events:
#         # Get employee attendance for this event
...
#         total_present += sum(
#             1 for emp in employees if emp.attendance and emp.attendance.lower() == "present"
#         )
...
#         "no_of_participants_trained",
#         total_present
#     )

#     frappe.msgprint(f"✅ Updated Training Program with {total_present} participants trained.")
