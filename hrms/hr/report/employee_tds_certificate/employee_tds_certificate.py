...
def get_salary_data(filters):
	...
	for d in frappe.db.sql("""
							SELECT 
								...
								(SELECT distinct(b.amount) FROM `tabSalary Detail` b WHERE b.parent = a.name AND b.salary_component = 'Salary Tax') AS tds, 
...
def get_columns():
    return [
        ...
        { "fieldname": "others", "label": "Other Allowances", "fieldtype": "Currency", "width": 140 },
		{ "fieldname": "comm_all", "label": "Comm. Allowance", "fieldtype": "Currency", "width": 140 },
