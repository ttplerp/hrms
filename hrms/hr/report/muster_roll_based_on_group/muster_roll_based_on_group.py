...
def get_columns():
    return [
        {
            "fieldname": "muster_roll_group",
            "label": "Muster Roll Group",
            "fieldtype": "Data",
            "width": 160
        },
        {
...
def get_data(filters):
    ...
    query = '''
        select count(name) as count, muster_roll_group from `tabMuster Roll Employee` where status="Active" group by muster_roll_group;
