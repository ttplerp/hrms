...
class EmployeePaymentEntry(PaymentEntry):
	def get_valid_reference_doctypes(self):
		if self.party_type == "Customer":
			...
			return ("Purchase Order", "Purchase Invoice", "Journal Entry","Repair And Service Invoice","Transporter Invoice","EME Invoice","Coal Raising Invoice", "Project Invoice", "POL Receive Invoice", "Transportation and Hire Charge Invoice")
