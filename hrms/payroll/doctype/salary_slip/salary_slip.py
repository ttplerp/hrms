...
class SalarySlip(TransactionBase):
	...
	def get_leave_details(self, joining_date=None, relieving_date=None, ss_doc=None, lwp=None):
		...
		if ss_doc:
			...
			#frappe.throw("{} {} {}".format(self.start_date, self.end_date, date_diff(self.end_date, self.start_date)))
	...
	def update_ot(self, cancel = False):
		...
		for a in self.ot_items:
			frappe.db.sql(""" update `tabOvertime Application` set processed = '{0}', salary_slip = '{3}', payment_made = '{4}'  where name = '{1}' and employee = '{2}'
